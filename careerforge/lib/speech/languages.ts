...
export const SUPPORTED_LANGUAGES: Record<string, SupportedLanguage> = {
  ...
  "en-GB": {
    ...
    speechSynthesisLocale: "en-GB",
    azureLocale: "en-GB",
    googleLocale: "en-GB",
    azureVoiceName: "en-GB-SoniaNeural",
    googleVoiceName: "en-GB-Journey-F",
  },
  "en-AU": {
    code: "en-AU",
    ...
    flag: "🇦🇺",
    speechRecognitionLocale: "en-AU",
    speechSynthesisLocale: "en-AU",
    azureLocale: "en-AU",
    googleLocale: "en-AU",
    azureVoiceName: "en-AU-NatashaNeural",
    googleVoiceName: "en-AU-Standard-A",
  },
  hi: {
    code: "hi",
    name: "Hindi",
